...
function humanReadable(seconds) {
    //finish sorting out the extreme cases
    ...
    seconds = seconds - (hours * 3600)  //check how many seconds are remaining from original seconds value
    if (hours < 10) {
      hours = '0' + hours
    }
    // Do the math for the minutes
    let minutes = Math.floor(seconds / 60)
    seconds = seconds - (minutes * 60) //check how many seconds are remaining from original seconds value
    if (minutes < 10) {
      minutes = '0' + minutes
    }
